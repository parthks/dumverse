...
export const interactivePointsMap1 = [
  { x: 84.7, y: 75, level: 1 },
  { x: 80, y: 80.5, level: 2 },
  { x: 72.8, y: 82.2, level: 3 },
  { x: 66.8, y: 80.7, level: 4 },
  { x: 60.6, y: 74.2, level: 5 },
  { x: 54, y: 74.5, level: 6 },
  { x: 50, y: 66, level: 7 },
  { x: 47.4, y: 53.8, level: 8 },
  { x: 45.3, y: 46.3, level: 9 },
  { x: 57, y: 32, level: 10 },
  { x: 65, y: 30, level: 11 },
  { x: 73, y: 32.6, level: 12 },
  { x: 81, y: 32.5, level: 13 },
  { x: 88, y: 28.5, level: 14 },
  { x: 76.8, y: 26, level: 15 },
  { x: 70, y: 25.6, level: 16 },
  { x: 61.7, y: 25.7, level: 17 },
  { x: 54, y: 28.7, level: 18 },
  { x: 49, y: 31.3, level: 19 },
  { x: 43, y: 31.7, level: 20 },
  { x: 37.5, y: 31.2, level: 21 },
  { x: 32.3, y: 32, level: 22 },
  { x: 27, y: 31.5, level: 23 },
  { x: 22.5, y: 29.7, level: 24 },
  { x: 17.8, y: 29.1, level: 25 },
  { x: 13, y: 25, level: 26 },
  { x: 7.5, y: 22.4, level: 27 },
];

// Map 2
export const interactivePointsMap2 = [
  { x: 90.2, y: 57.6, level: 28 },
  { x: 76, y: 68.7, level: 29 },
  { x: 54, y: 67.5, level: 30 },
  { x: 33, y: 68, level: 31 },
  { x: 16.5, y: 60, level: 32 },
  { x: 35, y: 54, level: 33 },
  { x: 53, y: 55, level: 34 },
  { x: 72, y: 53, level: 35 },
  { x: 86, y: 49.5, level: 36 },
  { x: 89.6, y: 38, level: 37 },
  { x: 77, y: 36, level: 38 },
  { x: 64, y: 38.2, level: 39 },
  { x: 52, y: 39.5, level: 40 },
  { x: 42, y: 40.5, level: 41 },
  { x: 33.5, y: 35, level: 42 },
  { x: 48, y: 28.5, level: 43 },
  { x: 69, y: 29, level: 44 },
  { x: 85.5, y: 27, level: 45 },
  { x: 79, y: 20.6, level: 46 },
  { x: 69, y: 19.5, level: 47 },
  { x: 60, y: 19, level: 48 },
  { x: 50, y: 20, level: 49 },
  { x: 42, y: 21, level: 50 },
  { x: 33.5, y: 22.8, level: 51 },
  { x: 24, y: 26, level: 52 },
  { x: 17.5, y: 34, level: 53 },
  { x: 12, y: 41.3, level: 54 },
];
