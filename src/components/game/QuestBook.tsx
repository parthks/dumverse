        ...
        <div className="grid grid-rows-[50%_20%_20%] h-full">
          <div>
            ...
            <p style={{ fontSize: `${24 * scale}px` }}>
              The Dum at the General Shop mentioned that legend tells of heart pieces stolen by a mystical creature who tricked Dumz into falling in love and broke their hearts.
              Find the creature and you will be rewarded.
            </p>
          </div>
          <div className="self-start flex items-center justify-center gap-2 text-center mx-auto">
            <img src="https://arweave.net/7BSdsML77_UihdbeCQqTNfAOH_SENqNCwk7ykIYekVI" alt="Keys" className="w-8" />{" "}
            <span style={{ fontSize: `${28 * scale}px` }}>Heart pieces found 0/4</span>
          </div>
      ...
      leftPage: (
        <div className="grid grid-rows-[50%_20%_20%] h-full">
          ...
          <div className="self-start flex items-center justify-center gap-2 text-center mx-auto">
            ...
            <span style={{ fontSize: `${28 * scale}px` }}>Magical Thread 0/8</span>
          </div>
          <div className="self-start">
            <h3 style={{ fontSize: `${28 * scale}px`, color: "#E19A4C" }}>Reward:</h3>
      ...
      rightPage: (
        <div className="grid grid-rows-[50%_20%_20%] h-full">
          ...
          <div className="self-start flex items-center justify-center gap-2 text-center mx-auto">
            ...
            <span style={{ fontSize: `${28 * scale}px` }}>Missing Cat 0/1</span>
          </div>
          <div className="self-start text-center mx-auto flex flex-col items-center gap-2">
            <h3 style={{ fontSize: `${28 * scale}px`, color: "#E19A4C" }}>Reward:</h3>
      ...
      leftPage: (
        <div className="grid grid-rows-[50%_20%_20%] h-full">
          ...
          <div className="self-start flex items-center justify-center gap-2 text-center mx-auto">
            ...
            <span style={{ fontSize: `${28 * scale}px` }}>Wood Core 0/8</span>
          </div>
          <div className="self-start">
            <h3 style={{ fontSize: `${28 * scale}px`, color: "#E19A4C" }}>Reward:</h3>
        ...
        >
          ...
          <button
            ...
            style={{
              width: `${73 * scale}px`,
              height: `${73 * scale}px`,
              backgroundImage: `url(https://arweave.net/SKu9BObCHuN4lJVIa9tnP7R4OzwikZzDw1C-ALSIP30)`,
              backgroundSize: "contain",
              backgroundRepeat: "no-repeat",
            }}
          ...
          <button
            ...
            style={{
              width: `${73 * scale}px`,
              height: `${73 * scale}px`,
              backgroundImage: `url(https://arweave.net/oLYsRSefknK9vSDBVcZ8-NGOXzu9JFZxxiU-BnkY6Pc)`,
              backgroundSize: "contain",
              backgroundRepeat: "no-repeat",
            }}
